...
// ── COLORS (matching evrything dark theme for this section) ──
const C = {
  bg: "#0a0f1a", surface: "#111827", surfaceHover: "#1a2335",
  border: "#1e293b", borderActive: "#f97316", accent: "#f97316",
  accentGlow: "rgba(249,115,22,0.15)", accentSoft: "rgba(249,115,22,0.08)",
  text: "#f1f5f9", textMuted: "#94a3b8", textDim: "#64748b",
  mapBg: "#0d1420", mapLand: "#1a2744", mapStroke: "#2a3a5c",
  dot: "#f97316", dotHover: "#fb923c", white: "#fff",
